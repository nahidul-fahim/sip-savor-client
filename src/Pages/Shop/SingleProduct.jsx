...
const SingleProduct = ({ singleProduct }) => {
    ...
    return (
        ...
        <div className=' flex flex-col justify-center items-center gap-3 p-4 relative'>
            ...
            <h4 className='text-[10px] font-body bg-lightMain px-3 py-1 text-white font-medium tracking-[2px] absolute top-6 right-6 uppercase'>{foodCategory}</h4>
            ...
            <div className='flex flex-col w-full justify-center items-start gap-3'>
                ...
                <div id='innerDiv' className="flex justify-between items-center w-full">
                    ...
                    <Link to={`${_id}`}><button className='bg-second text-[14px] uppercase font-medium px-3 py-1 text-white font-heading tracking-[1px] hover:bg-main duration-500 hover:scale-110'>Details</button></Link>
                </div>
            </div>
        </div>
    );
